...
#define NOTIFICATION_CheckNet @"checkNet" //检查网络通知
#define NOTIFICATION_Advertise @"advertisePush"  // 启动图广告通知
#define NOTIFICATION_RefreshVerificationImage @"refreshVerificationImage"  // 刷新验证图片
#define NOTIFICATION_CurrentStar @"currentStar"   // 当前星级
#define NOTIFICATION_RefreshHomePageData @"refreshHomePageData"  // 刷新首页数据
...
//快速block
#define Block(NAME) typedef void(^NAME)(id sender)
// 弱引用
#define CIWeakSelf(type)  __weak typeof(type) weak##type = type;
// 强引用
#define CIStrongSelf(type)  __strong typeof(type) type = weak##type;
//快速枚举
#define Enum(NAME) typedef NS_ENUM(NSInteger,NAME)
