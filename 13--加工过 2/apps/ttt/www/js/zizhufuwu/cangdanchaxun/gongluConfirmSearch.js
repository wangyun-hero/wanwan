...
/*
	var data = {
		dataInfo : [{
			...
			"decl_name" : "小涛",
			"transport_name" : "车4",
			"transport_rel_mark" : "0",
			"transport_id" : "2323431332",
			"sender_code" : "756382",
			"manifest_id" : "33234211221"
		}]
	}
	success(data)
	*/
	...
	$("#search_btn").click(function() {
		var inputVal = $("#huowu_search").val();
		var yunshuVal = $("#yunshu_search").val();
		var Type=true;
...
function success(result) {
	UM.hideLoadingBar();
	toPage('#page2');
	var dataText = doT.template($("#gongluConfirm").text());
	//加载数据
