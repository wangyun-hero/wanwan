...
;(function(window){
    ...
    u.fixStatusBar = function(el){
        ...
        var fullScreen = sysInfo.fullScreen||true;
...
function openNewView(modelName,linkUrl){  
   summer.openWin({
        id: modelName,
        name: modelName,
        url: linkUrl,
...
function clearTxt(e){
	$(".um-input-clear").prev("input").val("");
}

//
//var ipUrl= "172.100.5.199"; 
//服务器IP
